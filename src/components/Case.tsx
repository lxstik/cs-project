...
export default function Case({ caseItem }: { caseItem: CaseItem }) {
    return (
        <div key={caseItem.name} className="flex flex-col items-center justify-between h-full mb-4 text-center bg-[#1c1d21] p-4 rounded-lg w-48 flex-shrink-0">
            <img src={caseItem.image_url} alt={caseItem.name} className="w-36 h-36 mx-auto object-contain" />
            <div>
